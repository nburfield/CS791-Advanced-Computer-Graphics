...
void terrain::setup()
{
  ...
  Renderer.init();
  Renderer.addShader(GL_VERTEX_SHADER, "../shader/terrain_vertex.glsl");
  Renderer.addShader(GL_FRAGMENT_SHADER, "../shader/terrain_fragment.glsl");
...
void terrain::render(glm::mat4 view, glm::mat4 projection)
{
  ...
  Renderer.setGLVertexAttribPointer("poses", 3, GL_FLOAT, GL_FALSE, sizeof(Vertex), (void*)offsetof(Vertex, m_pos));
  Renderer.setGLVertexAttribPointer("Normal", 3, GL_FLOAT, GL_FALSE, sizeof(Vertex), (void*)offsetof(Vertex, m_normal));
  Renderer.setGLVertexAttribPointer("TexCoord", 2, GL_FLOAT, GL_TRUE, sizeof(Vertex), (void*)offsetof(Vertex, m_tex));
