...
{   
    ...
    m_billboardTechnique.Start();

    m_billboardTechnique.SetColorTextureUnit(COLOR_TEXTURE_UNIT_INDEX);

    m_billboardTechnique.SetBillboardSize(0.5f);
    
    m_pTexture = new Texture(GL_TEXTURE_2D, "../data/fireworks_red.jpg");
...
void ParticleSystem::Render(unsigned int DeltaTimeMillis, const glm::mat4 VP, const glm::vec3 CameraPos)
{
